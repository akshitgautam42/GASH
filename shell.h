...
extern int fg;
extern int exiting;
extern char home_of_shell[MAX_ARRAY_SIZE];
extern int changed_dir;
extern int no_bg_processes;
extern char processes[100][MAX_ARRAY_SIZE];
extern int pro_ids[100];
extern char fg_name[MAX_ARRAY_SIZE];

extern char previous_dir[MAX_ARRAY_SIZE];
